...
<head>
    ...
    <title>MARYTECHENOCK - Organizational Change Management</title>
    ...
    <div class="container-fluid bg-dark p-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-white">Organizational Change Management</h1>
                ...
                <i class="far fa-award text-primary px-2"></i>
                <a href="organisational-change-management.php">Business & Technology Advisory</a>
            </div>
        </div>
    </div>
    <!-- Page Header End -->

    <!-- Organizational Change Management start-->
    <!-- <div class="container-fluid pt-6 px-5" style="min-height: 500px;">
        Organizational Change Management INFO HERE... <br>
...
<!-- Quote End -->
    <!-- Organizational Change Management end-->
